...
init python:
    config.font_replacement_map["GOTHIC.TTF", True, False] = ("GOTHICB.TTF", False, False)
    config.font_replacement_map["GOTHIC.TTF", False, True] = ("GOTHICI.TTF", False, False)
    config.font_replacement_map["GOTHIC.TTF", True, True] = ("GOTHICBI.TTF", False, False)
    config.font_replacement_map["good timing.ttf", True, False] = ("good timing bd.ttf", False, False)
    
define config.font_name_map["lal"] = FontGroup().add("DejaVuSans.ttf", "?", "?").add("GOTHIC.TTF", None, None)
define config.font_name_map["gtb"] = "good timing bd.ttf"
define config.font_name_map["gt"] = "good timing.ttf"
...
define gui.accent_color = '#980002'
...
define gui.text_font = "lal"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "good timing.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "good timing.ttf"
...
# define gui.main_menu_background = "bg_main"
...
define gui.skip_frame_borders = Borders(20, 8, 20, 8)

## Рамки, используемые в частях экрана уведомлений.
define gui.notify_frame_borders = Borders(60, 35, 60, 40)
...
init python:
    ...
    def small():
        ...
        gui.textbox_height = 355
        gui.name_xpos = 175
        gui.name_ypos = 14
        gui.namebox_height = 90
        gui.dialogue_xpos = 210
        gui.dialogue_ypos = 107
        gui.dialogue_width = 1510
        ...
        gui.choice_button_height = 110
        gui.choice_spacing = 30
